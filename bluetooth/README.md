##Bluetooth
This is the bluetooth portion of the project.

for setting up the bluetooth the following knowledge is assumed:
* basic Linux (*nix also works too) command line knowledge
* basic undestanding on how bluetooth works
* Python knowledge

This project was tested using the Raspberry Pi 3 that comes with pi-bluetooth pre-loaded and working 'out of the box'. If you are using an older version set up pi-bluetooth before proceeding, multiple resources can be found online. Depending on your setup the following command should work:

```
sudo apt-get install pi-bluetooth
```

In this project we are using Bluez, Linux's Bluetooth protocol stack, we'll be using [PyBluez](https://github.com/karulis/pybluez), a Python API for accesing the bluetooth resources using the bluez protocol.
...
##Credits
This would not have been possible thanks to the following posts and online resources:
